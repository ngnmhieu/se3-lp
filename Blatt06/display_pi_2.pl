...
%display(Fenster-Ueberschrift,Liste1,Liste2)
display(Label,L1,L2):-
   ...
   display_sequence(@d,L1,5,80),    % Skalierungsfaktoren in x- und y-Richtung
   display_sequence(@d,L2,5,80).    % muessen an das Problem angepasst werden
